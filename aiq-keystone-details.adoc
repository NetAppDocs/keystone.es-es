...
=== Detalles adicionales de Protección de datos

.Haga clic aquí
[%collapsible]
====
Si se ha suscrito al servicio de protección de datos (DP), puede ver la división de los datos de consumo según los sitios asociados de MetroCluster en la pestaña *Serie de tiempo de suscripción*.
