...
** Gris: _Uso provisional_ - uso registrado cuando los datos exactos del período de tiempo no están disponibles y se sustituyen por los datos disponibles en el punto de recopilación de datos anterior.
