...
La pestaña *Serie de tiempo* muestra los datos históricos de tus suscripciones de Keystone durante un período específico. Los gráficos verticales muestran los detalles de uso del intervalo de tiempo seleccionado con los indicadores adecuados para que pueda comparar y generar informes.
...
[%collapsible]
====
Si se ha suscrito al servicio de protección de datos, puede ver la división de los datos de consumo de los sitios asociados de MetroCluster en la pestaña *Serie de tiempo*.
...
En la pestaña *Serie de tiempo*, tienes la opción de descargar el informe para los 30 puntos de recopilación de datos predeterminados del rango de fechas de tu consulta, o informes diarios.
